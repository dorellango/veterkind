  ...
  <div class="bg-grey-darkest px-4 py-16">
    <div class="container">
      ...
      <div class="flex justify-between text-grey flex-wrap">
        ...
        <div class="block md:flex items-center md:w-auto w-full">
          <p class="mb-2 md:mb-0">Clorinda Henríquez 80, La Reina.</p>
          <p class="flex items-center">
            <svg  class="h-4 w-4 fill-current md:mx-2 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000"><path d="M753.4 284.6l-124 214.5-123.9-214.5-123.9 214.5-123.9-214.5-124.1 214.6 124.1 214.7 123.9-214.5 123.9 214.5 123.9-214.6 124 214.6 124-214.7z"></path> <path d="M500 93.6C229.4 93.6 10 275.5 10 500c0 224.4 219.4 406.4 490 406.4s490-182 490-406.4c0-224.5-219.4-406.4-490-406.4zm0 777c-246.7 0-446.8-166-446.8-370.6 0-204.6 200-370.6 446.8-370.6 246.7 0 446.8 165.9 446.8 370.6 0 204.6-200.1 370.6-446.8 370.6z"></path></svg>
